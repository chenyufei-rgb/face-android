    ...
    public void sendFace(File file) throws FileNotFoundException {
        ...
        client.post(ProjectStatic.SERVICE_PATH + "document/saveImage", params, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                Log.d("MyApp", "Success: Status Code = " + statusCode);                  String studentId = name.substring(0,name.indexOf("_"));
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                ...
                Log.e("MyApp", "Failure: Status Code = " + statusCode + ", Error = " + error.getMessage());
